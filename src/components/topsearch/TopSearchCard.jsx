...
const TopSearchCard = ({ routeFrom, routeTo, timeDuration, price }) => {
  return (
    <div className='w-full rounded-xl p-5 border border-neutral-300 space-y-10'>
        ...
        <div className="space-y-0">
          ...
          <div className="w-full flex items-center justify-between gap-x-3">
            ...
            <div className="flex-1 border-dashed border-neutral-400 relative">
              <p className="absolute w-fit px-3 h-6 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-neutral-50 rounded-full flex items-center justify-center text-sm text-neutral-500 font-normal border border-dashed border-neutral-400">
                {timeDuration}
              </p>
            </div>
